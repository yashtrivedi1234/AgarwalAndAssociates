  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative w-full pb-[55%] md:pb-[40%] rounded-2xl overflow-hidden shadow-2xl bg-white border border-gray-200 hover:shadow-3xl transition-shadow duration-300">
          <iframe 
