        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-[1400px]">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                {/* Left accent line */}
                <span className="block w-6 h-[2px] bg-red-500 rounded-full" />

                {/* Badge pill */}
                <div
                  className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-red-500/50 bg-red-600/10 backdrop-blur-sm"
                  style={{ boxShadow: '0 0 16px rgba(220, 38, 38, 0.2)' }}
                >
                  {/* Dot */}
                  ...
                  <span className="text-red-300 text-xs font-semibold tracking-[0.2em] uppercase">
                    {slideData.tagline}
                  </span>
                </div>
